    ...
    */
    public class Empathy
    {
        ...
        public static ItemDef CreateItem()
        {
            ...
            item.pickupModelPrefab = Main.MainAssets.LoadAsset<GameObject>("Assets/Models/Prefabs/Items/Empathy2Prefab.prefab");
            item.pickupIconSprite = Main.MainAssets.LoadAsset<Sprite>("Assets/Materials/Icons/Empathy2Icon.png");
        ...
        public static void AddHooks(ItemDef itemDefToHooks, float Empathy_HealFor) // Insert hooks here
        {
            ...
            void OnHpLost2(HealthComponent healthComponent)
            {
